...
export type PageGroup='cover'|'front'|'title'|'contents'|'body'|'appendix'|'other';
export type BookPage={book_id:string;page:number;printed_page:number|null;page_group:PageGroup|'';page_label:string;title:string;unit:string;image:string;interactive:boolean};
...
export type Identity={id:number;email:string;kind:'student'|'teacher'|'admin';permissions:string[]};
